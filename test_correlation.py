...
def lws_rbspice_correlation(y_test_reshaped, y_test_pred_reshaped, xrange=[4,9],figname="tmp",ek="148"):
    ...
    x_tx = xrange[0]*0.4 + xrange[1]*0.6
    y_tx1= xrange[0]*0.7  + xrange[1]*0.3
    y_tx2= xrange[0]*0.75 + xrange[1]*0.25
    plt.text(x_tx,y_tx1,('R2: %(corr)5.3f' %{"corr": corr}),color='w',fontsize=20)
    plt.text(x_tx,y_tx2,('mse_test:%(mse_test)5.3f' %{"mse_test":mse_test1}),color='w',fontsize=20)
